...
const modules = [cron, conversationModule, conversationFlowModule, autoChats, autonomy];
...
const moduleStatusMessage = modules.map((mod) => {
  const colors = {
...
export default moduleStatusMessage.join('\n');
